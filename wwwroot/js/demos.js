            ...
            response.forEach(demo => {
                if (demo.isSpecialListItem) {
                    ...
                    if (demo.configHelpUrl) {
                        configHelpButton = `<br>&nbsp;<br><i class="bi bi-play-circle"></i> <a class="" style="margin-top: 100px;" role="button" href="${demo.configHelpUrl}"> Learn how Microsoft configured the Woodgrove tenant</a>`;
                    }
